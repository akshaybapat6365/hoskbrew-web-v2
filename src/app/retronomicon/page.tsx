    ...
    <>
      ...
      <Section spacing="loose">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="relative aspect-[3/4] overflow-hidden rounded-lg border border-brand-border bg-brand-bg-elevated">
          ...
          <div className="flex flex-col gap-6">
            ...
            <h2 className="text-heading text-brand-text">Inside This Issue</h2>
      ...
      <Section background="elevated" spacing="normal">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {PAST_ISSUES.map((issue) => (
            <div
              key={issue.number}
              className="group flex flex-col justify-between rounded-lg border border-brand-border bg-brand-bg p-6 transition-all hover:border-brand-primary/40"
            >
              <div>
