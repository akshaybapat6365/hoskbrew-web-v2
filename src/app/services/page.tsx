        ...
        <div className="flex flex-col gap-16">
          {services.map((service, i) => {
            ...
            return (
              <AnimateOnScroll
                key={service.slug}
                effect={isEven ? "fadeLeft" : "fadeRight"}
              >
                <div
                ...
                >
                  ...
                  <div className="hidden lg:col-span-2 lg:flex lg:items-center lg:justify-center">
                    <div className="relative overflow-hidden flex h-48 w-48 items-center justify-center rounded-2xl retro-border-glow bg-brand-bg-elevated scanline-sweep">
