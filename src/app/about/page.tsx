...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-brand-bg">
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center space-y-8">
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-retro text-brand-text text-shadow-crt"
          >
            PRESERVING THE <span className="text-brand-highlight">BIT</span>
          </motion.h1>
          <p className="text-xl md:text-2xl font-sans text-brand-text/80 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-24 bg-brand-surface/10 border-y border-brand-surface/30">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-retro text-brand-primary">
              ORIGIN STORY
            </h2>
            <p className="text-lg font-sans text-brand-text/70">
          ...
          <div className="relative h-[400px] bg-brand-bg-elevated border-4 border-brand-text shadow-[8px_8px_0px_0px_rgba(16,185,129,1)]">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-retro text-brand-text text-center mb-16">
            THE <span className="text-brand-highlight">CREW</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {team.map((member, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group bg-brand-surface/20 border border-brand-text/10 p-6 text-center hover:bg-brand-surface/40 transition-colors"
              >
                <div className="relative w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-2 border-brand-primary group-hover:scale-110 transition-transform">
                  <Image
                    src={member.image}
                    alt={member.name}
                    fill
                ...
                <h3 className="text-2xl font-retro text-brand-text">
                  {member.name}
                </h3>
                <p className="text-brand-primary font-mono text-sm uppercase mb-4">
                  {member.role}
                </p>
                <p className="text-brand-text/70 font-sans italic">
                  "{member.bio}"
                </p>
              </motion.div>
            ))}
