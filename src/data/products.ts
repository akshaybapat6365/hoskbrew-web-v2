...
export const products: Product[] = [
  {
    ...
    gallery: [
      "/assets/images/offerings/crystal-mines/01.png",
      "/assets/images/offerings/crystal-mines/02.png",
      "/assets/images/offerings/crystal-mines/03.png",
      "/assets/images/offerings/crystal-mines/04.png",
      "/assets/images/offerings/crystal-mines/05.png",
      "/assets/images/offerings/crystal-mines/06.png",
      "/assets/images/offerings/crystal-mines/07.png",
      "/assets/images/offerings/crystal-mines/08.png",
      "/assets/images/offerings/crystal-mines/09.png",
      "/assets/images/offerings/crystal-mines/10.png",
      "/assets/images/offerings/crystal-mines/11.png",
      "/assets/images/offerings/crystal-mines/12.png",
      "/assets/images/offerings/crystal-mines/13.png",
      "/assets/images/offerings/crystal-mines/14.png",
      "/assets/images/offerings/crystal-mines/15.png",
      "/assets/images/offerings/crystal-mines/16.png",
    ],
    featured: true,
    specs: [
